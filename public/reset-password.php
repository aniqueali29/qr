...
if (!$reset_record || $reset_record['token'] !== $token || strtotime($reset_record['expires_at']) < time()) {
    header('Location: forgot-password.php');
    exit();
}
    ...
    try {
        ...
        if (!validateCSRFToken($csrf_token)) {
            ...
            if ($student) {
                ...
                $stmt->execute([$password_hash, $student['student_id']]);
        ...
        error_log("[RESET_PASSWORD] Stack trace: " . $e->getTraceAsString());
            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <p class="mb-6">Enter your new password for <strong><?php echo htmlspecialchars($email); ?></strong></p>
                        ...
                        <form id="formResetPassword" class="mb-6" method="POST" action="">
                            ...
                            <button type="submit" class="btn btn-primary d-grid w-100 mb-4">Reset Password</button>
                        </form>
