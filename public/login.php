...
<head>
    ...
    <title>Student Login - <?php echo function_exists('getStudentProjectName') ? getStudentProjectName() : STUDENT_SITE_NAME; ?></title>
    <meta name="description" content="Student Portal Login - <?php echo function_exists('getStudentProjectName') ? getStudentProjectName() : 'QR Attendance System'; ?>" />
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    ...
                                    if (!function_exists('getStudentSystemLogo')) {
                                        require_once __DIR__ . '/includes/helpers.php';
                                    }
                                    
                                    $systemLogo = getStudentSystemLogo();
                                ...
                                <span class="app-brand-text demo text-heading fw-bold"><?php echo htmlspecialchars(function_exists('getStudentProjectShortName') ? getStudentProjectShortName() : 'QAS'); ?></span>
                            </a>
                        </div>
                        <!-- /Logo -->
